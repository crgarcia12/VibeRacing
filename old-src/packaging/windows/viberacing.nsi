...
!define PRODUCTNAME            "VibeRacing"
!define APPNAME-GAME           "VibeRacing"
!define APPNAME-EDITOR         "VibeRacing Level Editor"
!define COMPANYNAME            "Jussi Lind"
!define DESCRIPTION            "A traditional top-down racing game."
!define VERSIONMAJOR 2
!define VERSIONMINOR 2
!define VERSIONBUILD 0
!define HELPURL                "http://juzzlin.github.io/VibeRacing/"
!define UPDATEURL              "https://github.com/juzzlin/VibeRacing/releases"
!define ABOUTURL               "http://juzzlin.github.io/VibeRacing/"

;!define MUI_FILE               ""
!define MUI_BRANDINGTEXT       "VibeRacing"
;!define MUI_HEADERIMAGE
;!define MUI_HEADERIMAGE_BITMAP "${NSISDIR}\Contrib\Graphics\Header\orange.bmp"
!define MUI_ICON               "data\icons\VibeRacing.ico"
!define MUI_UNICON             "data\icons\VibeRacing.ico"
!define MUI_SPECIALBITMAP      "data\icons\VibeRacing.ico"
...
Name "${PRODUCTNAME}"
Icon "data\icons\VibeRacing.ico"
OutFile "viberacing-${VERSIONMAJOR}.${VERSIONMINOR}.${VERSIONBUILD}-windows-x86-qt5_setup.exe"
...
Section "install"
	...
	File viberacing-game.exe
	File viberacing-editor.exe
 	File /r data
	File CHANGELOG
	File COPYING
	File AUTHORS
	...
	CreateShortCut "$SMPROGRAMS\${PRODUCTNAME}\${APPNAME-GAME}.lnk" \
	    "$INSTDIR\viberacing-game.exe" "" "$INSTDIR\data\icons\VibeRacing.ico"
	CreateShortCut "$SMPROGRAMS\${PRODUCTNAME}\${APPNAME-EDITOR}.lnk" \
	    "$INSTDIR\viberacing-editor.exe" "" "$INSTDIR\data\icons\VibeRacingEditor.ico"
	CreateShortCut "$SMPROGRAMS\${PRODUCTNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" ""
 
	CreateShortCut "$DESKTOP\${APPNAME-GAME}.lnk" "$INSTDIR\viberacing-game.exe" "" "$INSTDIR\data\icons\VibeRacing.ico"
	CreateShortCut "$DESKTOP\${APPNAME-EDITOR}.lnk" "$INSTDIR\viberacing-editor.exe" "" "$INSTDIR\data\icons\VibeRacingEditor.ico"
...
Section "uninstall"
	...
	Delete   $INSTDIR\viberacing-game.exe
	Delete   $INSTDIR\viberacing-editor.exe
