...
void CarSoundEffectManager::collision(MCObject & collidingObject)
{
    ...
    if (!m_hitTimer.isActive() && speedDiff.lengthFast() > 4.0)
    {
          ...
          collidingObject.typeId() == MCObject::typeId("wall") || collidingObject.typeId() == MCObject::typeId("bridgeRail") || collidingObject.typeId() == MCObject::typeId("wallLong"))
        {
          ...
          collidingObject.typeId() == MCObject::typeId("vibeRacingBanner") || collidingObject.typeId() == MCObject::typeId("brake") || collidingObject.typeId() == MCObject::typeId("crate") || collidingObject.typeId() == MCObject::typeId("left") || collidingObject.typeId() == MCObject::typeId("plant") || collidingObject.typeId() == MCObject::typeId("right") || collidingObject.typeId() == MCObject::typeId("tire"))
        {
